...
Import statements are also supported code blocks
(as long as the supports [dynamic imports](https://caniuse.com/es6-module-dynamic-import)).
...
import theme from 'https://cdn.skypack.dev/prism-react-renderer/themes/oceanicNext';
...
all the packages themes from prism-react-renderer, under `jarle/themes` so you
...
Pressing <kbd>enter</kbd> or typing printable characters activates the tap trap,
