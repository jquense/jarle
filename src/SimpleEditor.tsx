// Vendored react-simple-code-editor
// https://github.com/react-simple-code-editor/react-simple-code-editor/blob/main/LICENSE.md
...
const SimpleEditor = React.forwardRef(function Editor(
  props: Props,
